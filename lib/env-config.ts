...
const FIREBASE_DEFAULTS = {
  NEXT_PUBLIC_FIREBASE_API_KEY: "AIzaSyCriToueLXKW-tDdUp0L0PKsjZo2ACjHjc",
  NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN: "promptspirit.firebaseapp.com",
  NEXT_PUBLIC_FIREBASE_PROJECT_ID: "promptspirit",
  NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET: "promptspirit.firebasestorage.app",
  NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID: "577964155956",
  NEXT_PUBLIC_FIREBASE_APP_ID: "1:577964155956:web:3f8a85864b980838581661",
} as const;
...
export const ENV_CONFIG = {
  ...
  FIREBASE_API_KEY:
    readEnv(process.env.NEXT_PUBLIC_FIREBASE_API_KEY) ?? FIREBASE_DEFAULTS.NEXT_PUBLIC_FIREBASE_API_KEY,
  FIREBASE_AUTH_DOMAIN:
    readEnv(process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN) ??
    FIREBASE_DEFAULTS.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN,
  FIREBASE_PROJECT_ID:
    readEnv(process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID) ?? FIREBASE_DEFAULTS.NEXT_PUBLIC_FIREBASE_PROJECT_ID,
  FIREBASE_STORAGE_BUCKET:
    readEnv(process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET) ??
    FIREBASE_DEFAULTS.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET,
  FIREBASE_MESSAGING_SENDER_ID:
    readEnv(process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID) ??
    FIREBASE_DEFAULTS.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID,
  FIREBASE_APP_ID:
    readEnv(process.env.NEXT_PUBLIC_FIREBASE_APP_ID) ?? FIREBASE_DEFAULTS.NEXT_PUBLIC_FIREBASE_APP_ID,
};
